  ...
  <a-modal :title="title" :width="800" :visible="visible" :confirmLoading="confirmLoading" @ok="handleOk"
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="所属平台" hasFeedback>
  ...
  export default {
    ...
    methods: {
      ...
      edit(record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model, 'roleName', 'description', 'roleCode', 'platformCode'))
          if (!this.model.id) {
            this.form.setFieldsValue({
              'roleCode': this.model.platformCode + "-"
            })
          }
          this.form.setFieldsValue({
      ...
      handleRoleCodeChange(e) {
        this.$nextTick(() => {
          ...
          if (!roleCode.startsWith(this.model.platformCode + "-")) {
            roleCode = this.model.platformCode + "-" + roleCode
          }
          this.form.setFieldsValue({
            'roleCode': roleCode
          })
