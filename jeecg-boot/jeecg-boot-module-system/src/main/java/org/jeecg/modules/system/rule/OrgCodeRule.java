...
public class OrgCodeRule implements IFillRuleHandler {
    ...
    public Object execute(JSONObject params, JSONObject formData) {
        ISysOrgService sysOrgService = (ISysOrgService) SpringContextUtils.getBean("sysOrgServiceImpl");
        ...
        if (StringUtil.isNullOrEmpty(parentId)) {
            ...
            orgList = sysOrgService.list(query1);
            ...
            // 查询出同级部门的集合
            List<SysOrg> parentList = sysOrgService.list(query);
            // 查询出父级部门
            SysOrg org = sysOrgService.getById(parentId);
            // 获取父级部门的Code
