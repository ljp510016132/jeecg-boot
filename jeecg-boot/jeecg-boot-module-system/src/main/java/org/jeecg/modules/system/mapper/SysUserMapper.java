...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return
	 */
	IPage<SysUser> getUserByOrgId(Page page, @Param("orgId") String orgId, @Param("username") String username);
	 ...
	 * @return
	 */
	List<SysUserSysOrgModel> getUserByOrgCode(IPage page, @Param("orgCode") String orgCode, @Param("userParams") SysUser userParams);
